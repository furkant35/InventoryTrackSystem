...
namespace InventoryTrackSystem.Data.Concrete
{
    ...
    public class Repository : IRepository
    {
        ...
        public TEntity Add<TEntity, TPrimaryKey>(TEntity entity) where TEntity : BaseEntity
        {
            _context.Set<TEntity>().Add(entity);
            return entity;
        }
        ...
        public async Task<TEntity> AddAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : BaseEntity
        {
            await _context.Set<TEntity>().AddAsync(entity, cancellationToken).ConfigureAwait(false);
            return entity;
        }
        ...
        public async Task<IEnumerable<TEntity>> AddRangeAsync<TEntity, TPrimaryKey>(IEnumerable<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : BaseEntity
        {
            await _context.Set<TEntity>().AddRangeAsync(entities, cancellationToken).ConfigureAwait(false);
            return entities;
        }
        ...
        public void HardDelete<TEntity, TPrimaryKey>(TEntity entity) where TEntity : BaseEntity
        {
            _context.Set<TEntity>().Remove(entity);
        }

        public void HardDelete<TEntity, TPrimaryKey>(TPrimaryKey id) where TEntity : BaseEntity
        {
        ...
        public Task HardDeleteAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : BaseEntity
        {
            _context.Set<TEntity>().Remove(entity);
            return Task.CompletedTask;
        }

        public async Task HardDeleteAsync<TEntity, TPrimaryKey>(TPrimaryKey id, CancellationToken cancellationToken = default) where TEntity : BaseEntity
        {
            var entity = await _context.Set<TEntity>().FirstOrDefaultAsync(GenerateExpression<TEntity>(id), cancellationToken).ConfigureAwait(false);
            _context.Set<TEntity>().Remove(entity);
        }
        ...
        public TEntity Replace<TEntity, TPrimaryKey>(TEntity entity) where TEntity : BaseEntity
        {
            _context.Entry(entity).State = EntityState.Modified;
            return entity;
        }
        ...
        public Task<TEntity> ReplaceAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : BaseEntity
        {
            _context.Entry(entity).State = EntityState.Modified;
            return Task.FromResult(entity);
        }

        public void SoftDelete<TEntity, TPrimaryKey>(TEntity entity) where TEntity : BaseEntity
        {
            Replace<TEntity, TPrimaryKey>(entity);
        }

        public void SoftDelete<TEntity, TPrimaryKey>(TPrimaryKey id) where TEntity : BaseEntity
        {
            var entity = _context.Set<TEntity>().FirstOrDefault(GenerateExpression<TEntity>(id));
            Replace<TEntity, TPrimaryKey>(entity);
        }

        public async Task SoftDeleteAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : BaseEntity
        {
            await ReplaceAsync<TEntity, TPrimaryKey>(entity, cancellationToken).ConfigureAwait(false);
        }

        public async Task SoftDeleteAsync<TEntity, TPrimaryKey>(TPrimaryKey id, CancellationToken cancellationToken = default) where TEntity : BaseEntity
        {
            var entity = await _context.Set<TEntity>().FirstOrDefaultAsync(GenerateExpression<TEntity>(id), cancellationToken).ConfigureAwait(false);
            await ReplaceAsync<TEntity, TPrimaryKey>(entity, cancellationToken).ConfigureAwait(false);
        }
        ...
        public TEntity Update<TEntity, TPrimaryKey>(TEntity entity) where TEntity : BaseEntity
        {
            _context.Set<TEntity>().Update(entity);
            return entity;
        }
        ...
        public Task<TEntity> UpdateAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : BaseEntity
        {
            _context.Set<TEntity>().Update(entity);
            return Task.FromResult(entity);
        }
        ...
        public IEnumerable<TEntity> UpdateRange<TEntity, TPrimaryKey>(IEnumerable<TEntity> entities) where TEntity : BaseEntity
        {
            _context.Set<TEntity>().UpdateRange(entities);
            return entities;
        }
        ...
        public async Task<IEnumerable<TEntity>> UpdateRangeAsync<TEntity, TPrimaryKey>(IEnumerable<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : BaseEntity
        {
            _context.Set<TEntity>().UpdateRange(entities);
            return entities;
        }
