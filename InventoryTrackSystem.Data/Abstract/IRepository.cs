...
namespace InventoryTrackSystem.Data.Abstract
{
    public interface IRepository
    {
        ...
        TEntity Add<TEntity, TPrimaryKey>(TEntity entity) where TEntity : BaseEntity;
        Task<TEntity> AddAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : BaseEntity;
        ...
        IEnumerable<TEntity> AddRange<TEntity, TPrimaryKey>(IEnumerable<TEntity> entities) where TEntity : BaseEntity;
        Task<IEnumerable<TEntity>> AddRangeAsync<TEntity, TPrimaryKey>(IEnumerable<TEntity> entites, CancellationToken cancellationToken = default) where TEntity : BaseEntity;
        ...
        void HardDelete<TEntity, TPrimaryKey>(TEntity entity) where TEntity : BaseEntity;
        Task HardDeleteAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : BaseEntity;
        void HardDelete<TEntity, TPrimaryKey>(TPrimaryKey id) where TEntity : BaseEntity;
        Task HardDeleteAsync<TEntity, TPrimaryKey>(TPrimaryKey id, CancellationToken cancellationToken = default) where TEntity : BaseEntity;
        void SoftDelete<TEntity, TPrimaryKey>(TEntity entity) where TEntity : BaseEntity;
        Task SoftDeleteAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : BaseEntity;
        void SoftDelete<TEntity, TPrimaryKey>(TPrimaryKey id) where TEntity : BaseEntity;
        Task SoftDeleteAsync<TEntity, TPrimaryKey>(TPrimaryKey id, CancellationToken cancellationToken = default) where TEntity : BaseEntity;
        ...
        TEntity Update<TEntity, TPrimaryKey>(TEntity entity) where TEntity : BaseEntity;
        Task<TEntity> UpdateAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : BaseEntity;
        IEnumerable<TEntity> UpdateRange<TEntity, TPrimaryKey>(IEnumerable<TEntity> entities) where TEntity : BaseEntity;
        Task<IEnumerable<TEntity>> UpdateRangeAsync<TEntity, TPrimaryKey>(IEnumerable<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : BaseEntity;
        ...
        TEntity Replace<TEntity, TPrimaryKey>(TEntity entity) where TEntity : BaseEntity;
        Task<TEntity> ReplaceAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : BaseEntity;
